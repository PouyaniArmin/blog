...
<body>
    ...
    <main class="p-4 border-bottom">
        ...
        <div>
            <div class="row g-5">
                <div class="col-md-3 border-end shadow">
                    <div class="position-sticky" style="top: 1rem;">
                        <div class="p-2 bg-light rounded">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <div class="row">
                                        <div class="col-1 py-2"><i style="color: #0d6efd;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-speedometer2" viewBox="0 0 16 16">
                                ...
                                <li class="nav-item">
                                    <div class="row">
                                        <div class="col-1 py-2"><i style="color: #0d6efd;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-plus" viewBox="0 0 16 16">
                                ...
                                <li class="nav-item">
                                    <div class="row">
                                        <div class="col-1 py-2"><i style="color: #0d6efd;">
